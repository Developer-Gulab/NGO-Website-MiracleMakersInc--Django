    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('donor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MMI_APP.donor')),
                ('donationarea', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='MMI_APP.donationarea')),
            ],
        ),
        migrations.CreateModel(
            name='Gallery',
            fields=[
                ...
                ('creationdate', models.DateTimeField(auto_now_add=True)),
                ('donation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MMI_APP.donation')),
            ],
        ),
        migrations.CreateModel(
            name='Volunteer',
        ...
        migrations.AddField(
            model_name='donation',
            name='volunteer',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='MMI_APP.volunteer'),
        ),
    ]
